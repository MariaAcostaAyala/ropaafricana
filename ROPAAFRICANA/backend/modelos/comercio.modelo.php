...
class ModeloComercio{
    ...
    MOSTRAR LOGOTIPO
    =============================================*/
    static public function mdlMostrarLogotipo($tabla) {
        $stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla");
        $stmt -> execute();
        return $stmt -> fetch();
        $stmt -> close();
    ...
    MOSTRAR ICONOS
    =============================================*/
    static public function mdlMostrarIconos($tabla) {
        $stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla");
        $stmt -> execute();
        return $stmt -> fetch();
        $stmt -> close();
    ...
    MOSTRAR COLORES
    =============================================*/
    static public function mdlMostrarColores($tabla) {
        $stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla");
        $stmt -> execute();
        return $stmt -> fetch();
        $stmt -> close();
    ...
    MOSTRAR SCRIPT
    =============================================*/
    static public function mdlMostrarScript($tabla) {
        $stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla");
        $stmt -> execute();
        return $stmt -> fetch();
        $stmt -> close();
    ...
    EDITAR LOGOTIPO
    =============================================*/
    static public function mdlEditarLogotipo($tabla, $datos) {
    ...
    EDITAR ICONOS
    =============================================*/
    static public function mdlEditarIconos($tabla, $datos) {
        $stmt = Conexion::conectar()->prepare("UPDATE $tabla SET icono = :icono WHERE id = :id");
    ...
    EDITAR COLORES
    =============================================*/
    static public function mdlEditarColores($tabla, $datos) {
        $stmt = Conexion::conectar()->prepare("UPDATE $tabla SET barraSuperior = :barraSuperior, textoSuperior = :textoSuperior, colorFondo = :colorFondo, colorTexto = :colorTexto WHERE id = :id");
        $stmt -> bindParam(":barraSuperior", $datos["barraSuperior"], PDO::PARAM_STR);
        $stmt -> bindParam(":textoSuperior", $datos["textoSuperior"], PDO::PARAM_STR);
        $stmt -> bindParam(":colorFondo", $datos["colorFondo"], PDO::PARAM_STR);
    ...
    static public function mdlEditarRedesSociales($tabla, $datos) {
        $stmt = Conexion::conectar()->prepare("UPDATE $tabla SET redesSociales = :redesSociales WHERE id = :id");
        $stmt -> bindParam(":redesSociales", $datos["redesSociales"], PDO::PARAM_STR);
        $stmt -> bindParam(":id", $datos["id"], PDO::PARAM_INT);
        if($stmt -> execute()) {
            return "ok";
        } else {
    ...
    EDITAR SCRIPT
    =============================================*/
    static public function mdlEditarScript($tabla, $datos) {
        $stmt = Conexion::conectar()->prepare("UPDATE $tabla SET apiFacebook = :apiFacebook, pixelFacebook = :pixelFacebook, googleAnalytics = :googleAnalytics WHERE id = :id");
        $stmt -> bindParam(":apiFacebook", $datos["apiFacebook"], PDO::PARAM_STR);
        $stmt -> bindParam(":pixelFacebook", $datos["pixelFacebook"], PDO::PARAM_STR);
        $stmt -> bindParam(":googleAnalytics", $datos["googleAnalytics"], PDO::PARAM_STR);
    ...
    =============================================*/
    static public function mdlActualizarRedesSociales($tabla, $id, $datos){

        $stmt = Conexion::conectar()->prepare("UPDATE $tabla SET redesSociales = :redesSociales WHERE id = :id");

        $stmt->bindParam(":redesSociales", $datos, PDO::PARAM_STR);
        $stmt->bindParam(":id", $id, PDO::PARAM_INT);
