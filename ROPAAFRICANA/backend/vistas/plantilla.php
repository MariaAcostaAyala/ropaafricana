<!DOCTYPE html>
<?php
require_once __DIR__ . "/../controladores/comercio.controlador.php";
?>
<!--
...
<head>
  ...
  ======================================-->
    ...
    <?php
    // Obtener el script de Facebook de la base de datos
    $plantilla = ControladorComercio::ctrMostrarScript();
    if(isset($plantilla["apiFacebook"]) && !empty($plantilla["apiFacebook"])) {
        echo $plantilla["apiFacebook"];
    }
    ?>
