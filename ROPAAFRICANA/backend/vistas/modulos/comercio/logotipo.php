...
$plantilla = ControladorComercio::ctrMostrarLogotipo();

// Valores por defecto si no existen
$logo = isset($plantilla["logo"]) ? $plantilla["logo"] : "vistas/img/plantilla/logo.png";
$icono = isset($plantilla["icono"]) ? $plantilla["icono"] : "vistas/img/plantilla/icono.png";
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <p class="pull-right">
                ...
                <img src="<?php echo $logo; ?>" class="img-thumbnail previsualizarLogo" width="200px">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <p class="pull-right">
                ...
                <img src="<?php echo $icono; ?>" class="img-thumbnail previsualizarIcono" width="50px">
