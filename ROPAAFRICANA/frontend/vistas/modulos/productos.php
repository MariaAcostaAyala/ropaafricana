...
if($banner && isset($banner["titulo1"]) && isset($banner["titulo2"]) && isset($banner["titulo3"])) {
    ...
    if($titulo1 && $titulo2 && $titulo3) {
        echo '<figure class="banner">
            ...
            <div class="textoBanner '.$banner["estilo"].'">
                <h1 style="color:'.($titulo1["color"] ?? '#000000').'">'.($titulo1["texto"] ?? '').'</h1>
                <h2 style="color:'.($titulo2["color"] ?? '#000000').'"><strong>'.($titulo2["texto"] ?? '').'</strong></h2>
                <h3 style="color:'.($titulo3["color"] ?? '#000000').'">'.($titulo3["texto"] ?? '').'</h3>
            </div>
        </figure>';
    }
}
...
<script src="/ROPAAFRICANA/frontend/vistas/js/carrito.js"></script>
</body>
</html>