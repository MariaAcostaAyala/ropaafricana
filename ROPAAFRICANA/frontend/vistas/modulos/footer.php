	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 col-xs-12 text-left infoContacto">
				...
				<h5><?php echo Configuracion::$empresa['slogan']; ?></h5>

				<br>
				
				<h5>
					
					<i class="fa fa-phone-square" aria-hidden="true"></i> <?php echo Configuracion::$contacto['telefono']; ?>

					<br><br>

					<i class="fa fa-envelope" aria-hidden="true"></i> <?php echo Configuracion::$contacto['email']; ?>

					<br><br>

					<i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo Configuracion::$contacto['direccion']; ?>

					<br><br>
					<?php echo Configuracion::$contacto['ciudad']; ?> | <?php echo Configuracion::$contacto['pais']; ?>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-6 col-xs-12 text-left text-muted">
				...
				<h5>&copy; <?php echo date('Y'); ?> Todos los derechos reservados. Sitio elaborado por <?php echo Configuracion::$configuracion['empresa']['compania']; ?></h5>
				<a href="<?php echo $url; ?>politica-privacidad" class="text-muted">Política de Privacidad</a>
