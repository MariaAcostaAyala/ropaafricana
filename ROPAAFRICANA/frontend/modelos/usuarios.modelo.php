...
class ModeloUsuarios{
	...
	static public function mdlRegistroUsuario($tabla, $datos){
		...
		try {
			error_log("Datos recibidos en mdlRegistroUsuario: " . print_r($datos, true));
			...
			error_log("Ejecutando consulta de registro...");
			
			if($stmt->execute()){
				$id = Conexion::conectar()->lastInsertId();
				error_log("Usuario registrado exitosamente con ID: " . $id);
				return ["ok", "id" => $id];
			}

			error_log("Error al ejecutar la consulta de registro");
			return "error";

		} catch(PDOException $e) {
			error_log("Error en mdlRegistroUsuario: " . $e->getMessage());
